  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 flex items-center justify-center p-8">
      <div className="text-center text-white space-y-8">
        ...
        <Button className="font-sans bg-white text-indigo-900 transform hover:scale-110 transition duration-300 ease-in-out">
            <Link to="/sign-up">Get Started</Link>
          </Button>
          <Button className="font-sans border-white text-white hover:bg-white/10 transform hover:scale-110 transition duration-300 ease-in-out">
